...
.. tabs::
   .. tab:: Python
      ...
      .. py:class:: xara.UniaxialMaterial("ASDConcrete1D", E, **kwargs)
         ...
         :type E: |float|
         :param fc: concrete compressive strength (optional)
         :type fc: |float|
         :param ft: concrete tensile strength (optional)
         :type ft: |float|
         :param Te: list of total-strain values for the tensile hardening-softening law (optional)
         :type Te: |floatTuple|
         :param Ts: list of stress values for the tensile hardening-softening law (optional)
         :type Ts: |floatTuple|
         :param Td: list of damage values for the tensile hardening-softening law (optional)
         :type Td: |floatTuple|
         :param Ce: list of total-strain values for the compressive hardening-softening law (optional)
         :type Ce: |floatTuple|
         :param Cs: list of stress values for the compressive hardening-softening law (optional)
         :type Cs: |floatTuple|
         :param Cd: list of damage values for the compressive hardening-softening law (optional)
         :type Cd: |floatTuple|
         :gparam Integration implex: If defined, the IMPL-EX integration will be used, otherwise the standard implicit integration will be used (default).
         :gtype implex: |bool|
         :gparam Integration implexControl: Activates the control of the IMPL-EX error. It is a tuple of two floats: (implexErrorTolerance, implexTimeReductionLimit). If the error introduced by the IMPL-EX algorithm is larger than implexErrorTolerance, the material will fail during the computation. The user can therfore use an adaptive time-step to reduce the time-step to keep the error under control. If the reduction of the time-step is smaller than implexTimeReductionLimit, the error control will be skipped. Suggested values: (0.05, 0.01).
         :gtype implexControl: |floatTuple|
...
.. note::
  ...
  * This model is the uniaxial specialization of the nDMaterial :ref:`ASDConcrete3D`. For the theory, please refer to :ref:`ASDConcrete3D`
